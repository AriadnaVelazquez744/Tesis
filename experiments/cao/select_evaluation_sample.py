...
SOURCE_FILE = "experiments/queries_creation/fixtures/expanded/expanded_queries.jsonl"
OUTPUT_FILE = "experiments/cao/data/evaluation_sample_v1.json"
SUMMARY_FILE = "experiments/cao/data/evaluation_sample_v1_summary.json"
