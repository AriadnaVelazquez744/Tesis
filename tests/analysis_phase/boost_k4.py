...
Usage:
    python tests/analysis_phase/boost_k4.py              # 1 LLM call — fix MATH-UTIL-002 v6
    python tests/analysis_phase/boost_k4.py --all         # up to 6 calls — fix + boost all UTIL seeds
    python tests/analysis_phase/boost_k4.py --seed MIX-UTIL-002 --variant 4  # custom (1 call)
"""
