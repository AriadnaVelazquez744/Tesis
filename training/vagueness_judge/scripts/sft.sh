...
TRAINING_DIR="${REPO_ROOT}/training/vagueness_judge"
...
# Modelo a entrenar (nombre de carpeta dentro de training/base_models/)
# Ejemplos:
...
MODEL_CONFIG_PATH="${MODEL_CONFIG_PATH:-${REPO_ROOT}/training/vagueness_judge/model_configs/${MODEL_DIR_NAME}.json}"
...
ARGS=(
  "${REPO_ROOT}/training/vagueness_judge/sft.py"
